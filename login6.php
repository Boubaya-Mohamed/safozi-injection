...
<div class="col-sm-4">
    ...
    $page_files=array( 'safozi-box'=>'safozi-box.php',

                    'safozi-cluster'=>'safozi-cluster.php',

                    'safozi-cdn'=>'safozi-cdn.php',

                    'safozi-diy'=>'safozi-diy.php',
                    'home'=>'',

                  );
if (isset( $_GET['safozi'] ) ){

if (in_array($_GET['safozi'],array_keys($page_files))) {

      include $page_files[$_GET['safozi']];
